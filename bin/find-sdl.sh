...
if [ -d "/opt/homebrew/Cellar/sdl2/2.30.2" ]; then
    export SDL2_PATH="/opt/homebrew/Cellar/sdl2/2.30.2"
elif [ -d "/tmp/.sdl/SDL2-2.30.2" ]; then
    export SDL2_PATH="/tmp/.sdl/SDL2-2.30.2"
else
    echo "SDL2 not found!"
